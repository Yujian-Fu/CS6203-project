...
def test_conf(base_para, choice_para, name):
    ...
    run_test(base_para, current_time, "cifar_" + name)
...
if __name__ == "__main__":
    ...
    if mode == "cen" or mode == "all":
        ...
        logger.info("Testing Centralized Single-Shot on Cifar")
    ...
    if mode == "double_pix" or mode == "all":
        check_correctness = True
        logger.info("Testing Double Pixel Single-Shot on Cifar")
    ...
    if mode == "half_attack" or mode == "all":
        check_correctness = True
        logger.info("Testing Half Attack Single-Shot on Cifar")
        test_conf(base.parameter_base, half_attack_sing.parameters, "half_attack_sing")

        logger.info("Testing Half Attack Multi-Shot on Cifar")
